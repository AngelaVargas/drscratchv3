...
var scratchblocks = function() {
    ...
    function t() {
        return t = Object.assign || function(e) {
            for (var t, s = 1; s < arguments.length; s++)
                for (var o in t = arguments[s], t) Object.prototype.hasOwnProperty.call(t, o) && (e[o] = t[o]);
            return e
        }, t.apply(this, arguments)
    }

    function s(e) {
        return o(e.replace(E, " _ "))
    }
    ...
    function i(e, t) {
        ...
        }), t.nativeAliases = {}, Object.keys(t.aliases).forEach(function(e) {
            var i = t.aliases[e],
                a = N[i];
            if (a === void 0) throw new Error("Invalid alias '" + i + "'");
            var n = s(e);
            o[n] = a, t.nativeAliases[i] = e
        }), Object.keys(t.renamedBlocks || {}).forEach(function(e) {
            var o = t.renamedBlocks[e];
            if (!T[o]) throw new Error("Unknown ID: " + o);
            var i = T[o],
                a = s(e);
            B.blocksByHash[a] = i
        }), t.nativeDropdowns = {}, Object.keys(t.dropdowns).forEach(function(e) {
            var s = t.dropdowns[e];
    ...
    function n(e, t) {
        if (!T[e]) throw new Error("Unknown ID: " + e);
        T[e].specialCase = t
    }
    ...
    function d(e, t, s) {
        var a = [];
        p(t[t.length - 1]) && (a = t.pop());
        for (var n, r = [], c = 0; c < t.length; c++) n = t[c], n.isLabel ? r.push(n.value) : n.isIcon ? r.push("@" + n.name) : r.push("_");
        var l = r.join(" "),
            h = e.hash = he(l),
            d = de(h, e, t, s);
        if (d) {
            var o = d.lang,
                u = d.type;
            e.language = o, e.isRTL = -1 < fe.indexOf(o.code), ("ring" === u.shape ? "reporter" === e.shape : "stack" === e.shape) && (e.shape = u.shape), e.category = u.category, e.categoryIsDefault = !0, u.selector && (e.selector = u.selector), u.id && (e.id = u.id), e.hasLoopArrow = u.hasLoopArrow, ". . ." === u.spec && (t = [new ee(". . .")])
        }
        ge(e, a), e.hasLoopArrow && t.push(new te("loopArrow"));
        var g = new oe(e, t);
        return (u && me.test(u.spec) && g.translate(o, !0), "+" === e.diff) ? new ae(g) : (g.diff = e.diff, g)
    }
    ...
    function u(e, t) {
        ...
        function c(e, s) {
            var o = !!s.filter(function(e) {
                ...
                i = {
                    shape: e,
                    category: "define-hat" === e ? "custom" : "reporter" !== e || o ? "obsolete" : "variables",
                    categoryIsDefault: !0,
                    hasLoopArrow: !1
                };
            return d(i, s, t)
        ...
        function p(e) {
            for (var t, s = []; v && "\n" !== v;) {
                if ("<" === v || ">" === v && ">" === e) {
                    var i = s[s.length - 1],
                        l = n();
                    if (i && !i.isLabel && ("[" === l || "(" === l || "<" === l || "{" === l)) {
                        t = null, s.push(new ee(v)), o();
                        continue
                    }
                }
                if (v === e) break;
                ...
                switch (v) {
                    ...
                    case "@":
                        ...
                        "cloud" === c ? s.push(new ee("\u2601")) : s.push(te.icons.hasOwnProperty(c) ? new te(c) : new ee("@" + c)), t = null;
                        break;
                    case "\\":
                        o();
                    case ":":
        ...
        function u() {
            ...
            return "]" === v && o(), pe.test(e) ? new se("color", e) : !t && / v$/.test(e) ? l("dropdown", e.slice(0, e.length - 2)) : new se("string", e)
        }
        ...
        function f(e) {
            ...
            if (v && "\n" === v && (O = !0, o()), 0 !== t.length) {
                var s = t[0];
                if (s && s.isLabel && r(s.value)) return 2 > t.length && t.push(c("outline", [])), c("define-hat", t);
                if (1 === t.length) {
                    var i = t[0];
        ...
        function m() {
            if (o(), " " === v && (o(), "v" === v && ")" === a())) return o(), o(), new se("number-dropdown", "");
            var e = p(")");
            if (v && ")" === v && o(), 0 === e.length) return new se("number", "");
            if (1 === e.length && e[0].isLabel) {
                var t = e[0].value;
                if (/^[0-9e.-]*$/.test(t)) return new se("number", t);
                if (pe.test(t)) return new se("color", t)
            }
            ...
            if (r.info && "ring" === r.info.shape) {
                var h = r.children[0];
                h && h.isInput && "number" === h.shape && "" === h.value ? r.children[0] = new se("reporter") : (h && h.isScript && h.isEmpty || h && h.isBlock && !h.children.length) && (r.children[0] = new se("stack"))
            }
            return r
        }
        ...
        function y() {
            o();
            var e = p(">");
            return v && ">" === v && o(), 0 === e.length ? new se("boolean") : c("boolean", e)
        }
        ...
        function b() {
            ...
            return t.forEach(function(e) {
                s = s.concat(e.blocks)
            }), "}" === v && o(), O ? new ne(s) : (h(1 >= s.length), s.length ? s[0] : c("stack", []))
        }

        function k() {
            var e = v;
            return o(), "\u25B8" === e ? new te("addInput") : "\u25C2" === e ? new te("delInput") : void 0
        }
    ...
    function g(e) {
        ...
        function o() {
            ...
            for (var e = []; n;) {
                for (var o = []; n && "NL" !== n;) {
                    var a = i(),
                        r = "+" === a.diff;
                    if (r && (a.diff = null), (a.isElse || a.isEnd) && (a = new oe(t({}, a.info, {
                            shape: "stack"
                        }), a.children)), r) {
                        var c = o[o.length - 1],
                            l = [];
                        ...
                        l.push(a), o.push(new ae(new ne(l)))
                    } else if (a.isHat) o.length && e.push(new ne(o)), o = [a];
                    else if (a.isFinal) {
                        o.push(a);
                        break
                    } else if (a.isCommand) o.push(a);
                    else {
                        o.length && e.push(new ne(o)), e.push(new ne([a])), o = [];
                        break
                    }
                }
                for (o.length && e.push(new ne(o));
                    "NL" === n;) s()
            }
            return e
        }
        ...
        function i() {
            ...
            if (s(), e.hasScript)
                for (;;) {
                    var t = a();
                    if (e.children.push(new ne(t)), n && n.isElse) {
                        for (var o = 0; o < n.children.length; o++) e.children.push(n.children[o]);
                        s();
                        continue
                    }
                    n && n.isEnd && s();
        ...
        function a() {
            for (var e = []; n;) {
                ...
                if (o && (t.diff = null), o) {
                    ...
                    r.push(t), e.push(new ae(new ne(r)))
                } else e.push(t)
            }
            return e
        }
        ...
        e.forEach(function(e) {
            ...
            f(e, function(e) {
                if (e.isBlock)
                    if ("define-hat" === e.info.shape) {
                        ...
                        e.info.id = "PROCEDURES_DEFINITION", e.info.selector = "procDef", e.info.call = u.spec, e.info.names = u.names, e.info.category = "custom"
                    } else if (e.info.categoryIsDefault && (e.isReporter || e.isBoolean)) {
                    var p = ye(e);
                    o[p] && (e.info.category = "custom-arg", e.info.categoryIsDefault = !1, e.info.selector = "getParam")
                } else if (be.hasOwnProperty(e.info.selector)) {
                    var g = be[e.info.selector],
            ...
            f(e, function(e) {
                if (e.info && e.info.categoryIsDefault && "obsolete" === e.info.category) {
                    var i = t[e.info.hash];
                    return void(i && (e.info.selector = "call", e.info.call = i.spec, e.info.names = i.names, e.info.category = "custom"))
                }
                var a, i;
                if (e.isReporter && "variables" === e.info.category && e.info.categoryIsDefault && (e.info.selector = "readVariable", a = ye(e), i = e.info), !!a)
                    if (s[a]) i.category = "list", i.categoryIsDefault = !1, i.selector = "contentsOfList:";
                    else if (o[a]) i.category = "variables", i.categoryIsDefault = !1, i.selector = "readVariable";
                else return
            })
        })
    }
    ...
    function y(e, s) {
        ...
        e = e.replace(/&lt;/g, "<"), e = e.replace(/&gt;/g, ">"), s.inline && (e = e.replace(/\n/g, " "));
    ...
    var S = ["motion", "looks", "sound", "pen", "variables", "list", "events", "control", "sensing", "operators", "custom", "custom-arg", "extension", "grey", "obsolete", "music", "video", "tts", "translate", "wedo", "ev3", "microbit", "makeymakey"],
        L = ["hat", "cap", "stack", "boolean", "reporter", "ring"],
        O = /\%([0-9]+)/,
        v = /(%[a-zA-Z0-9](?:\.[a-zA-Z0-9]+)?)/,
        E = new RegExp(v.source, "g"),
        R = /(@[a-zA-Z]+)/,
        I = new RegExp([v.source, "|", R.source, "| +"].join(""), "g"),
        C = /^#(?:[0-9a-fA-F]{3}){1,2}?$/,
        T = {},
        N = {},
        M = [{
            ...
            var s = {
                id: e.id,
                spec: e.spec,
                parts: e.spec.split(I).filter(function(e) {
                    return !!e
                }),
            ...
            if (T[s.id]) throw new Error("Duplicate ID: " + s.id);
            return T[s.id] = s, N[t] = s
        }),
        P = {
            "@greenFlag": "\u2691",
            "@turnRight": "\u21BB",
    ...
    M.forEach(function(e) {
        B.commands[e.spec] = e.spec
    }), a({
        en: B
    }), r("OPERATORS_MATHOP", "SENSING_OF", function(e, t) {
        var s = e[0];
        if (s.isInput) {
            var o = s.value;
            return -1 < t.math.indexOf(o)
        }
    }), r("SOUND_CHANGEEFFECTBY", "LOOKS_CHANGEEFFECTBY", function(e, t) {
        for (var s, a = 0; a < e.length; a++)
            if (s = e[a], "dropdown" === s.shape) {
                var n = s.value,
                    r = !0,
                    c = !1,
                    l = void 0;
                try {
                    for (var p, h, d = t.soundEffects[Symbol.iterator](); !(r = (p = d.next()).done); r = !0)
                        if (h = p.value, o(h) === o(n)) return !0
                } catch (e) {
                    c = !0, l = e
                } finally {
                    try {
    ...
    }), r("SOUND_SETEFFECTO", "LOOKS_SETEFFECTTO", function(e, t) {
        for (var s, a = 0; a < e.length; a++)
            if (s = e[a], "dropdown" === s.shape) {
                var n = s.value,
                    r = !0,
    ...
    }), r("DATA_LENGTHOFLIST", "OPERATORS_LENGTH", function(e) {
        var t = e[e.length - 1];
        return t.isInput ? "dropdown" === t.shape : void 0
    }), r("DATA_LISTCONTAINSITEM", "OPERATORS_CONTAINS", function(e) {
        var t = e[0];
        return t.isInput ? "dropdown" === t.shape : void 0
    }), r("pen.setColor", "pen.setHue", function(e) {
        var t = e[e.length - 1];
        return t.isInput && t.isColor || t.isBlock
    }), n("CONTROL_STOP", function(e, s, o) {
        var i = s[s.length - 1];
        if (i.isInput) {
            var a = i.value;
            if (-1 < o.osis.indexOf(a)) return t({}, T.CONTROL_STOP, {
                shape: "stack"
            })
        }
    });
    var x = {
            ...
            applyOverrides: function(e, t) {
                for (var s, o = 0; o < t.length; o++) s = t[o], C.test(s) ? (e.color = s, e.category = "", e.categoryIsDefault = !1) : -1 < S.indexOf(s) ? (e.category = s, e.categoryIsDefault = !1) : -1 < L.indexOf(s) ? e.shape = s : "loop" === s ? e.hasLoopArrow = !0 : ("+" === s || "-" === s) && (e.diff = s)
            },
    ...
    Y.prototype.isLabel = !0, Y.prototype.stringify = function() {
        return "<" === this.value || ">" === this.value ? this.value : this.value.replace(/([<>[\](){}])/g, "\\$1")
    };
    var K = function e(t) {
        this.name = t, this.isArrow = "loopArrow" === t, c(e.icons[t], "no info for icon " + t)
    };
    K.prototype.isIcon = !0, K.icons = {
        greenFlag: !0,
        turnLeft: !0,
        turnRight: !0,
        loopArrow: !0,
    ...
    var W = function(e, t, s) {
        this.shape = e, this.value = t, this.menu = s || null, this.isRound = "number" === e || "number-dropdown" === e, this.isBoolean = "boolean" === e, this.isStack = "stack" === e, this.isInset = "boolean" === e || "stack" === e || "reporter" === e, this.isColor = "color" === e, this.hasArrow = "dropdown" === e || "number-dropdown" === e, this.isDarker = "boolean" === e || "stack" === e || "dropdown" === e, this.isSquare = "string" === e || "color" === e || "dropdown" === e, this.hasLabel = !(this.isColor || this.isInset), this.label = this.hasLabel ? new Y(t, "literal-" + this.shape) : null, this.x = 0
    };
    W.prototype.isInput = !0, W.prototype.stringify = function() {
        if (this.isColor) return c("#" === this.value[0]), "[" + this.value + "]";
        var e = (this.value ? "" + this.value : "").replace(/ v$/, " \\v").replace(/([\]\\])/g, "\\$1");
        return this.hasArrow && (e += " v"), this.isRound ? "(" + e + ")" : this.isSquare ? "[" + e + "]" : this.isBoolean ? "<>" : this.isStack ? "{}" : e
    }, W.prototype.translate = function() {
        if (this.hasArrow) {
            var e = this.menu || this.value;
            this.value = e, this.label = new Y(this.value, "literal-" + this.shape)
        }
    };
    var X = function(e, s, o) {
        c(e), this.info = t({}, e), this.children = s, this.comment = o || null, this.diff = null;
        var i = this.info.shape;
        this.isHat = "hat" === i || "define-hat" === i, this.hasPuzzle = "stack" === i || "hat" === i, this.isFinal = /cap/.test(i), this.isCommand = "stack" === i || "cap" === i || /block/.test(i), this.isOutline = "outline" === i, this.isReporter = "reporter" === i, this.isBoolean = "boolean" === i, this.isRing = "ring" === i, this.hasScript = /block/.test(i), this.isElse = "celse" === i, this.isEnd = "cend" === i
    };
    X.prototype.isBlock = !0, X.prototype.stringify = function(e) {
        var t = null,
            s = !1,
            o = this.children.map(function(e) {
                return e.isIcon && (s = !0), t || e.isLabel || e.isIcon || (t = e), e.isScript ? "\n" + l(e.stringify()) + "\n" : e.stringify().trim() + " "
            }).join("").trim(),
            i = this.info.language;
        if (s && i && this.info.selector) {
            var a = F[this.info.id],
                n = a.spec,
                r = i.nativeAliases[a.spec];
            if (r) return z.test(r) && t && (r = r.replace(z, t.stringify())), r
        }
        var c = e || "";
    ...
    }, X.prototype.translate = function(e, t) {
        var s = this;
        if (!e) throw new Error("Missing language");
        var o = this.info.id;
        if (o) {
            if ("PROCEDURES_DEFINITION" === o) return c(this.children[0].isLabel), void(this.children[0] = new Y(e.define[0] || U.define[0]));
            var i = F[o],
                a = this.info.language.commands[i.spec],
                n = e.commands[i.spec];
            if (n) {
                var r = H(n),
                    l = this.children.filter(function(e) {
                ...
                var p = H(a).parts,
                    ...
                    d = 0,
                    u = h.map(function(e) {
                        return d = A(d, e), l[e - 1]
                    }),
                    g = l.slice(d);
                this.children = r.parts.map(function(e) {
                    var e = e.trim();
                    if (e) {
                        var t = G(e);
                        return t ? u[t - 1] : V.test(e) ? new K(e.slice(1)) : new Y(e)
                    }
                }).filter(function(e) {
                    return !!e
                }), g.forEach(function(t, o) {
                    1 === o && "CONTROL_IF" === s.info.id && s.children.push(new Y(e.commands["else"])), s.children.push(t)
                }), this.info.language = e, this.info.isRTL = -1 < _.indexOf(e.code), this.info.categoryIsDefault = !0
            }
        }
    };
    var q = function(e, t) {
        this.label = new Y(e, "comment-label"), this.width = null, this.hasBlock = t
    };
    q.prototype.isComment = !0, q.prototype.stringify = function() {
        return "// " + this.label.value
    };
    var Z = function(e) {
        c(e), this.child = e, e.isBlock ? (this.shape = e.info.shape, this.info = e.info) : this.shape = "stack"
    };
    Z.prototype.isGlow = !0, Z.prototype.stringify = function() {
    ...
    Q.prototype.isScript = !0, Q.prototype.stringify = function() {
        return this.blocks.map(function(e) {
            var t = e.stringify();
            return e.comment && (t += " " + e.comment.stringify()), t
        }).join("\n")
    }, Q.prototype.translate = function(e) {
    ...
    }, J.prototype.translate = function(e) {
    ...
    var $ = {
            ...
            var i, a, n = {
                ...
                c = e.exports = {
                    init: function(e) {
                        i = e.document;
                        var t = e.DOMParser;
                        a = new t().parseFromString("<xml></xml>", "application/xml"), c.XMLSerializer = e.XMLSerializer
                    },
                    makeCanvas: function() {
                    ...
                    translatePath: function(e, t, s) {
                        for (var a, n = !0, r = s.split(" "), c = [], l = 0; l < r.length; l++) {
                            if (a = r[l], "A" === a) {
                                ...
                                continue
                            } else /[A-Za-z]/.test(a) ? o(n) : (a = +a, a += n ? e : t, n = !n);
                            c.push(a)
                        }
                        return c.join(" ")
                    },
                    ...
                    getRightAndBottom: function(e, t, s, o) {
                        ...
                        return s && (i = i.concat(["L", o + 27, t, "L", o + 24, t + 3, "L", o + 16, t + 3, "L", o + 13, t])), i = 0 < o ? i.concat(["L", o + 2, t, "L", o, t + 2]) : i.concat(["L", o + 3, t, "L", 0, t - 3]), i.join(" ")
                    },
                    getArm: function(e, t) {
                    ...
                    mouthRect: function(e, t, o, a, n) {
                        for (var r, l = a[0].height, h = [c.getTop(e), c.getRightAndBottom(e, l, !0, 15)], p = 1; p < a.length; p += 2) {
                            r = p + 2 === a.length, l += a[p].height - 3, h.push(c.getArm(e, l));
                            var d = !(r && o),
                                u = r ? 0 : 15;
                            l += a[p + 1].height + 3, h.push(c.getRightAndBottom(e, l, d, u))
                        }
                        return c.path(s(n, {
                            path: h
                        }))
        ...
        ft = Ne.commentRect,
        mt = Ne.commentLine,
        yt = Ne.strikethroughLine,
        bt = function(e, t) {
            this.el = Ne.el("filter", b(t, {
                id: e,
                x0: "-50%",
                y0: "-50%",
                width: "200%",
    ...
    bt.prototype.fe = function(e, t, s) {
        var o = e.toLowerCase().replace(/gaussian|osite/, ""),
            i = [o, "-", ++this.highestId].join("");
        return this.el.appendChild(Ne.withChildren(Ne.el("fe" + e, b(t, {
            result: i
        })), s || [])), i
    }, bt.prototype.comp = function(e, t, s, o) {
        return this.fe("Composite", b(o, {
            operator: e,
            in: t,
            in2: s
        }))
    }, bt.prototype.subtract = function(e, t) {
        return this.comp("arithmetic", e, t, {
            k2: 1,
            k3: -1
        })
    }, bt.prototype.offset = function(e, t, s) {
        return this.fe("Offset", {
            in: s,
            dx: e,
            dy: t
        })
    }, bt.prototype.flood = function(e, t, s) {
        return this.fe("Flood", {
            in: s,
            "flood-color": e,
            "flood-opacity": t
        })
    }, bt.prototype.blur = function(e, t) {
        return this.fe("GaussianBlur", {
            in: t,
            stdDeviation: [e, e].join(" ")
        })
    }, bt.prototype.colorMatrix = function(e, t) {
    ...
    var kt = bt,
            ...
            var t = e.exports = {
                ...
                makeIcons: function() {
                    return [Ne.el("path", {
                        ...
                        fill: "#111",
                        id: "delInput"
                    }), Ne.setProps(Ne.group([Ne.el("path", {
                        d: "M8 0l2 -2l0 -3l3 0l-4 -5l-4 5l3 0l0 3l-8 0l0 2",
                        fill: "#000",
                        opacity: "0.3"
                    }), Ne.move(-1, -1, Ne.el("path", {
                        d: "M8 0l2 -2l0 -3l3 0l-4 -5l-4 5l3 0l0 3l-8 0l0 2",
                        fill: "#fff",
                        opacity: "0.9"
                    }))]), {
                ...
                makeStyle: function() {
                    var e = Ne.el("style");
                    return e.appendChild(Ne.cdata(t.cssContent)), e
                },
                bevelFilter: function(e, t) {
                    var o = new kt(e),
                        ...
                        a = t ? -1 : 1,
                        s = o.blur(1, i);
                    return o.merge(["SourceGraphic", o.comp("in", o.flood("#fff", .15), o.subtract(i, o.offset(+a, +a, s))), o.comp("in", o.flood("#000", .7), o.subtract(i, o.offset(-a, -a, s)))]), o.el
                },
                darkFilter: function(e) {
                    var t = new kt(e);
                    return t.merge(["SourceGraphic", t.comp("in", t.flood("#000", .2), "SourceAlpha")]), t.el
                },
                darkRect: function(e, t, s, o) {
                    return Ne.setProps(Ne.group([Ne.setProps(o, {
        ...
        Vt = wt.darkFilter,
        _t = function(e) {
            t(this, e), this.el = null, this.height = 12, this.metrics = null, this.x = 0
        };
    _t.prototype.isLabel = !0, _t.prototype.draw = function() {
        return this.el
    }, Object.defineProperty(_t.prototype, "width", {
        get: function() {
            return this.metrics.width
        }
    }), _t.metricsCache = {}, _t.toMeasure = [], _t.prototype.measure = function() {
        var e = this.value,
            t = "sb-" + this.cls;
        this.el = Ne.text(0, 10, e, {
            class: "sb-label " + t
        });
        var s = _t.metricsCache[t];
        if (s || (s = _t.metricsCache[t] = Object.create(null)), Object.hasOwnProperty.call(s, e)) this.metrics = s[e];
        else {
            var o = /comment-label/.test(this.cls) ? "bold 12px Helevetica, Arial, DejaVu Sans, sans-serif" : /literal/.test(this.cls) ? "normal 9px " + xt : "bold 10px " + xt;
            this.metrics = s[e] = _t.measure(e, o)
        }
    }, _t.measure = function(e, t) {
        var s = _t.measuring;
        s.font = t;
    ...
    jt.prototype.isIcon = !0, jt.prototype.draw = function() {
    ...
    var Ut = function(e) {
        t(this, e), e.label && (this.label = Qt(e.label)), this.x = 0
    };
    Ut.prototype.measure = function() {
    ...
    }, Ut.prototype.draw = function(e) {
        if (this.hasLabel) var t = this.label.draw(),
            s = A(14, this.label.width + ("string" === this.shape || "number-dropdown" === this.shape ? 6 : 9));
        ...
        var o = this.height = this.isRound || this.isColor ? 13 : 14,
            i = Ut.shapes[this.shape](s, o);
        this.isColor ? Ne.setProps(i, {
            fill: this.value
        }) : this.isDarker && (i = zt(s, o, e.info.category, i), e.info.color && Ne.setProps(i, {
            fill: e.info.color
        }));
        var a = Ne.group([Ne.setProps(i, {
            class: ["sb-input", "sb-input-" + this.shape].join(" ")
        })]);
        if (this.hasLabel) {
            var n = this.isRound ? 5 : 4;
            a.appendChild(Ne.move(n, 0, t))
        }
        if (this.hasArrow) {
            var r = "dropdown" === this.shape ? 5 : 4;
            a.appendChild(Ne.move(s - 10, r, Ne.polygon({
    ...
    var Yt = function(e) {
        switch (t(this, e), this.children = e.children.map(Qt), this.comment = this.comment ? Qt(this.comment) : null, this.info.category) {
            case "music":
    ...
    Yt.prototype.isBlock = !0, Yt.prototype.measure = function() {
        for (var e, t = 0; t < this.children.length; t++) e = this.children[t], e.measure && e.measure();
        ...
        ring: Ne.roundedRect
    }, Yt.prototype.drawSelf = function(e, t, s) {
        if (1 < s.length) return Ne.mouthRect(e, t, this.isFinal, s, {
            class: ["sb-" + this.info.category, "sb-bevel"].join(" ")
        });
        if ("outline" === this.info.shape) return Ne.setProps(Ne.stackRect(e, t), {
            class: "sb-outline"
        });
        if (this.isRing) {
            ...
            if (o && (o.isInput || o.isBlock || o.isScript)) {
                ...
                return Ne.ringRect(e, t, o.y, o.width, o.height, i, {
                    class: ["sb-" + this.info.category, "sb-bevel"].join(" ")
                })
            }
        }
        var a = Yt.shapes[this.info.shape];
        if (!a) throw new Error("no shape func: " + this.info.shape);
        return a(e, t, {
            class: ["sb-" + this.info.category, "sb-bevel"].join(" ")
        })
    }, Yt.prototype.minDistance = function(e) {
        ...
        function e(e) {
            0 === S.length ? g.height += a + r : (g.height += e ? 0 : 2, g.y -= 1), c += g.height, S.push(g)
        }
        var t = "define-hat" === this.info.shape,
            s = this.children,
            o = Yt.padding[this.info.shape] || Yt.padding[null],
            a = o[0],
            n = o[1],
            r = o[2],
            c = 0,
        ...
        if (this.info.isRTL) {
            for (var f = 0, m = function() {
                ...
                }.bind(this), b = 0; b < s.length; b++) s[b].isScript && (m(), f = b + 1);
            f < b && m()
        }
        for (var w, S = [], b = 0; b < s.length; b++)
            if (w = s[b], w.el = w.draw(this), w.isScript && this.isCommand) this.hasScript = !0, e(), w.y = c, S.push(w), u = A(u, A(1, w.width)), w.height = A(12, w.height) + 3, c += w.height, g = new l(c);
            else if (w.isArrow) g.children.push(w);
        else {
            var L = 0 < b ? 30 : 0,
                O = this.isCommand ? 0 : this.minDistance(w),
                v = this.isCommand ? w.isBlock || w.isInput ? L : 0 : O;
            v && !S.length && g.width < v - n && (g.width = v - n), w.x = g.width, g.width += w.width, d = A(d, g.width + A(0, O - n)), g.width += 4, w.isLabel || (g.height = A(g.height, w.height)), g.children.push(w)
        }
        if (e(!0), d = A(d + 2 * n, this.isHat || this.hasScript ? 83 : this.isCommand || this.isOutline || this.isRing ? 39 : 20), this.height = c, this.width = u ? A(d, 15 + u) : d, t) {
            var E = k(26, 0 | 3.5 + .13 * d) - 18;
            this.height += E, a += 2 * E
        }
        this.firstLine = S[0], this.innerWidth = d;
        for (var g, p = [], b = 0; b < S.length; b++) {
            if (g = S[b], g.isScript) {
                p.push(Ne.move(15, g.y, g.el));
                continue
            }
            for (var w, R = g.height, h = 0; h < g.children.length; h++) {
                if (w = g.children[h], w.isArrow) {
                    p.push(Ne.move(d - 15, this.height - 3, w.el));
                    continue
                }
                var c = a + (R - w.height - a - r) / 2 - 1;
                if ((t && w.isLabel ? c += 3 : w.isIcon && (c += 0 | w.dy), !(this.isRing && (w.y = 0 | g.y + c, w.isInset))) && (p.push(Ne.move(n + w.x, 0 | g.y + c, w.el)), "+" === w.diff)) {
                    var I = Ne.insEllipse(w.width, w.height);
                    p.push(Ne.move(n + w.x, 0 | g.y + c, I))
                }
            }
        }
        var C = this.drawSelf(d, this.height, S);
        return p.splice(0, 0, C), this.info.color && Ne.setProps(C, {
            fill: this.info.color
        }), Ne.group(p)
    };
    var Kt = function(e) {
        t(this, e), this.label = Qt(e.label), this.width = null
    };
    Kt.prototype.isComment = !0, Kt.lineLength = 12, Kt.prototype.height = 20, Kt.prototype.measure = function() {
        this.label.measure()
    }, Kt.prototype.draw = function() {
        var e = this.label.draw();
        return this.width = this.label.width + 16, Ne.group([Ne.commentLine(this.hasBlock ? Kt.lineLength : 0, 6), Ne.commentRect(this.width, this.height, {
            class: "sb-comment"
        }), Ne.move(8, 4, e)])
    };
    var Wt = function(e) {
        t(this, e), this.child = Qt(e.child), this.width = null, this.height = null, this.y = 0
    };
    Wt.prototype.isGlow = !0, Wt.prototype.measure = function() {
        this.child.measure()
    }, Wt.prototype.drawSelf = function() {
        var e, t = this.child,
            s = this.width,
            o = this.height - 1;
        if (t.isScript) e = !t.isEmpty && t.blocks[0].isHat ? Ne.hatRect(s, o) : t.isFinal ? Ne.capRect(s, o) : Ne.stackRect(s, o);
        else var e = t.drawSelf(s, o, []);
        return Ne.setProps(e, {
            class: "sb-diff sb-diff-ins"
        })
    }, Wt.prototype.draw = function() {
        var e = this.child,
            t = e.isScript ? e.draw(!0) : e.draw();
        return this.width = e.width, this.height = e.isBlock && e.firstLine.height || e.height, Ne.group([t, this.drawSelf()])
    };
    var Xt = function(e) {
        t(this, e), this.blocks = e.blocks.map(Qt), this.y = 0
    };
    Xt.prototype.isScript = !0, Xt.prototype.measure = function() {
        ...
        for (var o = 0; o < this.blocks.length; o++) {
            var a = this.blocks[o],
                n = e ? 0 : 2,
                r = a.draw();
            t.push(Ne.move(n, s, r)), this.width = A(this.width, a.width);
            var c = a.diff;
            if ("-" === c) {
                var l = a.width,
                    p = a.firstLine.height || a.height;
                t.push(Ne.move(n, s + p / 2 + 1, Ne.strikethroughLine(l))), this.width = A(this.width, a.width)
            }
            s += a.height;
            var h = a.comment;
            if (h) {
                var d = a.firstLine,
                    u = a.innerWidth + 2 + Kt.lineLength,
                    g = s - a.height + d.height / 2,
                    f = h.draw();
                t.push(Ne.move(u, g - h.height / 2, f)), this.width = A(this.width, u + h.width)
            }
        }
        return this.height = s, e || this.isFinal || (this.height += 3), !e && a.isGlow && (this.height += 2), Ne.group(t)
    };
    var qt = function(e) {
        t(this, e), this.scripts = e.scripts.map(Qt), this.width = null, this.height = null, this.el = null, this.defs = null
    };
    qt.prototype.measure = function() {
        ...
        this.measure();
        for (var e, t = 0, s = 0, o = [], a = 0; a < this.scripts.length; a++) e = this.scripts[a], s && (s += 10), e.y = s, o.push(Ne.move(0, s, e.draw())), s += e.height, t = A(t, e.width + 4);
        this.width = t, this.height = s;
        var n = Ne.newSVG(t, s);
        return n.appendChild(this.defs = Ne.withChildren(Ne.el("defs"), [Gt("bevelFilter", !1), Gt("inputBevelFilter", !0), Vt("inputDarkFilter")].concat(Ht()))), n.appendChild(Ne.group(o)), this.el = n, n
    ...
    var Zt = function(e) {
        ...
        $t = {
            init: function(e) {
                Ne.init(e), Jt.LabelView.measuring = function() {
                    var e = Ne.makeCanvas();
                    return e.getContext("2d")
                }()
            },
            newView: Jt.newView,
            makeStyle: wt.makeStyle
        },
        es = e(function(e) {
            function s(e, s) {
                return t({}, e, s)
            ...
            var o, i, a = {
                ...
                n = e.exports = {
                    init: function(e) {
                        o = e.document;
                        var t = e.DOMParser;
                        i = new t().parseFromString("<xml></xml>", "application/xml"), n.XMLSerializer = e.XMLSerializer
                    },
                    makeCanvas: function() {
                    ...
                    pointedPath: function(e, t) {
                        var s = t / 2;
                        return [
                            ["M", s, 0].join(" "), ["L", e - s, 0, e, s].join(" "), ["L", e, s, e - s, t].join(" "), ["L", s, t, 0, s].join(" "), ["L", 0, s, s, 0].join(" "), "Z"
                        ]
                    },
                    pointedRect: function(e, t, o) {
                        return n.path(s(o, {
                    ...
                    getRightAndBottom: function(e, t, s, o) {
                        "undefined" == typeof o && (o = 0);
                        var i = [
                            ["L", e, t - 4].join(" "), "a 4 4 0 0 1 -4 4"
                        ];
                        return s && (i = i.concat([
                            ["L", o + 48, t].join(" "), "c -2 0 -3 1 -4 2", "l -4 4", "c -1 1 -2 2 -4 2", "h -12", "c -2 0 -3 -1 -4 -2", "l -4 -4", "c -1 -1 -2 -2 -4 -2"
                        ])), 0 === o ? (i.push("L", o + 4, t), i.push("a 4 4 0 0 1 -4 -4")) : (i.push("L", o + 4, t), i.push("a 4 4 0 0 0 -4 4")), i.join(" ")
                    },
                    getArm: function(e, t) {
                        return [
                            ["L", 16, t - 4].join(" "), "a 4 4 0 0 0 4 4", ["L", 28, t].join(" "), n.topNotch(e, t)
                        ].join(" ")
                    },
                    getArmNoNotch: function(e, t) {
                        return [
                            ["L", 16, t - 4].join(" "), "a 4 4 0 0 0 4 4", ["L", 28, t].join(" "), ["L", e - 4, t].join(" "), "a 4 4 0 0 1 4 4"
                        ].join(" ")
                    },
                    stackRect: function(e, t, o) {
                        return n.path(s(o, {
                    ...
                    mouthRect: function(e, t, o, a, r) {
                        for (var c = a[0].height, l = [n.getTop(e), n.getRightAndBottom(e, c, !0, 16)], p = 1; p < a.length; p += 2) {
                            var h = p + 2 === a.length,
                                d = a[p];
                            c += d.height - 3, d.isFinal ? l.push(n.getArmNoNotch(e, c)) : l.push(n.getArm(e, c));
                            var u = h ? 0 : 16;
                            c += a[p + 1].height + 3, l.push(n.getRightAndBottom(e, c, !(h && o), u))
                        }
                        return l.push("Z"), n.path(s(r, {
                            path: l
                        }))
                    },
                    commentRect: function(e, t, o) {
        ...
        Fs = e(function(e) {
            var t = e.exports = {
                ...
                makeIcons: function() {
                    return [es.setProps(es.group([es.el("path", {
                        ...
                        id: "sb3-greenFlag"
                    }), es.setProps(es.group([es.el("path", {
                    ...
                    }), es.setProps(es.group([es.el("circle", {
                        opacity: .25,
                        cx: 32,
                        cy: 16,
                        r: 4.5
                        ...
                        id: "sb3-wedoBlock",
                        fill: "none"
                    }), es.setProps(es.group([es.el("rect", {
                        stroke: "#7C87A5",
                        fill: "#FFF",
                        x: ".5",
                        y: "3.59",
                ...
                makeStyle: function() {
                    var e = es.el("style");
                    return e.appendChild(es.cdata(t.cssContent)), e
                },
    ...
    to.prototype.isLabel = !0, to.prototype.draw = function() {
        return this.el
    }, Object.defineProperty(to.prototype, "width", {
        get: function() {
            return this.metrics.width
        }
    }), to.metricsCache = {}, to.toMeasure = [], to.prototype.measure = function() {
        var e = this.value,
            t = "sb3-" + this.cls;
        this.el = es.text(0, 13, e, {
            class: "sb3-label " + t
        });
        var s = to.metricsCache[t];
        if (s || (s = to.metricsCache[t] = Object.create(null)), Object.hasOwnProperty.call(s, e)) this.metrics = s[e];
        else {
            var o = /comment-label/.test(this.cls) ? Js : Qs;
            this.metrics = s[e] = to.measure(e, o)
        }
    }, to.measure = function(e, t) {
        var s = to.measuring;
        s.font = t;
        var o = s.measureText(e),
            i = 0 | o.width + .5;
    ...
    so.prototype.isIcon = !0, so.prototype.draw = function() {
        return es.symbol("#sb3-" + this.name, {
            width: this.width,
            height: this.height
        })
    }, so.icons = {
    ...
    oo.prototype.isLine = !0, oo.prototype.measure = function() {}, oo.prototype.draw = function(e) {
    ...
    var io = function(e) {
        t(this, e), e.label && (this.label = ho(e.label)), this.isBoolean = "boolean" === this.shape, this.isDropdown = "dropdown" === this.shape, this.isRound = !(this.isBoolean || this.isDropdown), this.x = 0
    };
    io.prototype.isInput = !0, io.prototype.measure = function() {
        this.hasLabel && this.label.measure()
    }, io.shapes = {
        string: es.pillRect,
        number: es.pillRect,
        "number-dropdown": es.pillRect,
        color: es.pillRect,
        dropdown: es.roundRect,
        boolean: es.pointedRect,
        stack: es.stackRect,
        reporter: es.pillRect
    }, io.prototype.draw = function(e) {
        ...
        var i = this.height = 32,
            a = io.shapes[this.shape](t, i);
        es.setProps(a, {
            class: [this.isColor ? "" : "sb3-" + e.info.category, "sb3-input", "sb3-input-" + this.shape].join(" ")
        }), this.isColor ? es.setProps(a, {
            fill: this.value
        }) : "dropdown" === this.shape ? e.info.color && es.setProps(a, {
            fill: e.info.color,
            stroke: "rgba(0, 0, 0, 0.2)"
        }) : "number-dropdown" === this.shape ? (a.classList.add("sb3-" + e.info.category + "-alt"), e.info.color && es.setProps(a, {
            fill: "rgba(0, 0, 0, 0.1)",
            stroke: "rgba(0, 0, 0, 0.15)"
        })) : "boolean" === this.shape && (a.classList.remove("sb3-" + e.info.category), a.classList.add("sb3-" + e.info.category + "-dark"), e.info.color && es.setProps(a, {
            fill: "rgba(0, 0, 0, 0.15)"
        }));
        var n = es.group([a]);
        return this.hasLabel && n.appendChild(s), this.hasArrow && n.appendChild(es.move(t - 24, 13, es.symbol("#sb3-dropdownArrow", {}))), n
    };
    var ao = function(e) {
        switch (t(this, e), this.children = e.children.map(ho), this.comment = this.comment ? ho(this.comment) : null, this.isRound = this.isReporter, this.info = t({}, e.info), this.info.category) {
            case "music":
                this.children.unshift(new oo), this.children.unshift(new so({
                    name: "musicBlock"
                })), this.info.category = "extension";
                break;
            case "pen":
    ...
    ao.prototype.isBlock = !0, ao.prototype.measure = function() {
        for (var e, t = 0; t < this.children.length; t++) e = this.children[t], e.measure && e.measure();
        this.comment && this.comment.measure()
    }, ao.shapes = {
        stack: es.stackRect,
        ...
        boolean: es.pointedRect,
        hat: es.hatRect,
        "define-hat": es.procHatRect,
        ring: es.pillRect
    }, ao.prototype.drawSelf = function(e, t, s) {
        if (1 < s.length) return es.mouthRect(e, t, this.isFinal, s, {
            class: ["sb3-" + this.info.category].join(" ")
        });
        if ("outline" === this.info.shape) return es.setProps(es.stackRect(e, t), {
        ...
        if (this.isRing) {
            ...
            if (o && (o.isInput || o.isBlock || o.isScript)) {
                ...
                return es.roundRect(e, t, {
                    class: ["sb3-" + this.info.category].join(" ")
                })
            }
        }
        var i = ao.shapes[this.info.shape];
        ...
        "define-hat": [20, 16],
        null: [4, 4]
    }, ao.prototype.horizontalPadding = function(e) {
        if (this.isRound) {
        ...
        return 8
    }, ao.prototype.marginBetween = function(e, t) {
        return e.isLabel && t.isLabel ? 5 : 8
    }, ao.prototype.draw = function() {
        function e() {
            0 === S.length ? u.height += n + r : (u.height -= 11, u.y -= 2), c += u.height, S.push(u)
        }
        var t = "define-hat" === this.info.shape,
            s = this.children,
            o = this.isCommand,
            a = ao.padding[this.info.shape] || ao.padding[null],
            n = a[0],
            r = a[1],
            c = 0,
            l = function(e) {
                this.y = e, this.width = 0, this.height = o ? 40 : 32, this.children = []
            },
            p = 0,
            d = 0,
            u = new l(c);
        if (this.info.isRTL) {
            for (var g = 0, f = function() {
                ...
                }.bind(this), m = 0; m < s.length; m++) s[m].isScript && (f(), g = m + 1);
            g < m && f()
        }
        for (var b, k, w, S = [], m = 0; m < s.length; m++)
            if (w = s[m], w.el = w.draw(this), w.isScript && this.isCommand) this.hasScript = !0, e(), w.y = c - 1, S.push(w), d = A(d, A(1, w.width)), w.height = A(29, w.height + 3) - 2, c += w.height, u = new l(c), b = null;
            else if (w.isArrow) u.children.push(w), b = w;
        else {
            S.length || (k = w), b && (u.width += this.marginBetween(b, w));
            var L = 48 - this.horizontalPadding(s[0]);
            (this.isCommand || this.isOutline) && !w.isLabel && !w.isIcon && u.width < L && (u.width = L), w.isIcon && 0 == m && this.isCommand && (u.height = A(u.height, w.height + 8)), w.x = u.width, u.width += w.width, p = A(p, u.width), w.isLabel || (u.height = A(u.height, w.height)), u.children.push(w), b = w
        }
        e();
        var O = this.horizontalPadding(s[0]),
            v = this.horizontalPadding(k);
        p += O + v, p = A(this.hasScript ? 160 : this.isHat ? 108 : this.isCommand || this.isOutline ? 64 : 0, p), this.height = c, this.width = d ? A(p, 15 + d) : p, this.firstLine = S[0], this.innerWidth = p;
        for (var u, E = [], m = 0; m < S.length; m++) {
            if (u = S[m], u.isScript) {
                E.push(es.move(16, u.y, u.el));
                continue
            }
            for (var w, R = u.height, h = 0; h < u.children.length; h++) {
                if (w = u.children[h], w.isArrow) {
                    E.push(es.move(p - 32, this.height - 28, w.el));
                    continue
                }
                var c = n + (R - w.height - n - r) / 2;
                w.isLabel && 0 == m ? c -= 1 : t && w.isLabel ? c += 3 : w.isIcon && (c += 0 | w.dy, this.isCommand && 0 == m && 0 == h && (c += 4));
                var I = O + w.x;
                w.dx && (I += w.dx), E.push(es.move(I, 0 | u.y + c, w.el))
            }
        }
        var C = this.drawSelf(p, this.height, S);
        return E.splice(0, 0, C), this.info.color && es.setProps(C, {
            fill: this.info.color,
            stroke: "rgba(0, 0, 0, 0.2)"
        }), es.group(E)
    };
    var no = function(e) {
        t(this, e), this.label = ho(e.label), this.width = null
    };
    no.prototype.isComment = !0, no.lineLength = 12, no.prototype.height = 20, no.prototype.measure = function() {
        this.label.measure()
    }, no.prototype.draw = function() {
        var e = this.label.draw();
        return this.width = this.label.width + 16, es.group([es.commentLine(this.hasBlock ? no.lineLength : 0, 6), es.commentRect(this.width, this.height, {
            class: "sb3-comment"
        }), es.move(8, 4, e)])
    };
    var ro = function(e) {
        t(this, e), this.child = ho(e.child), this.width = null, this.height = null, this.y = 0
    };
    ro.prototype.isGlow = !0, ro.prototype.measure = function() {
        this.child.measure()
    }, ro.prototype.drawSelf = function() {
        var e, t = this.child,
            s = this.width,
            o = this.height - 1;
        if (t.isScript) e = !t.isEmpty && t.blocks[0].isHat ? es.hatRect(s, o) : t.isFinal ? es.capRect(s, o) : es.stackRect(s, o);
        else var e = t.drawSelf(s, o, []);
        return es.setProps(e, {
            class: "sb3-diff sb3-diff-ins"
        })
    }, ro.prototype.draw = function() {
        var e = this.child,
            t = e.isScript ? e.draw(!0) : e.draw();
        return this.width = e.width, this.height = e.isBlock && e.firstLine.height || e.height, es.group([t, this.drawSelf()])
    };
    var co = function(e) {
        t(this, e), this.blocks = e.blocks.map(ho), this.y = 0
    };
    co.prototype.isScript = !0, co.prototype.measure = function() {
        for (var e = 0; e < this.blocks.length; e++) this.blocks[e].measure()
        ...
        for (var o = 0; o < this.blocks.length; o++) {
            var a = this.blocks[o],
                n = e ? 0 : 2,
                r = a.draw();
            t.push(es.move(n, s, r)), this.width = A(this.width, a.width);
            var c = a.diff;
            if ("-" === c) {
                var l = a.width,
                    p = a.firstLine.height || a.height;
                t.push(es.move(n, s + p / 2 + 1, es.strikethroughLine(l))), this.width = A(this.width, a.width)
            }
            s += a.height;
            var h = a.comment;
            if (h) {
                var d = a.firstLine,
                    u = a.innerWidth + 2 + no.lineLength,
                    g = s - a.height + d.height / 2,
                    f = h.draw();
                t.push(es.move(u, g - h.height / 2, f)), this.width = A(this.width, u + h.width)
            }
        }
        return this.height = s + 1, e || this.isFinal || (this.height += a.hasPuzzle ? 44 : 36), !e && a.isGlow && (this.height += 2), es.group(t)
    };
    var lo = function(e) {
        t(this, e), this.scripts = e.scripts.map(ho), this.width = null, this.height = null, this.el = null, this.defs = null
    };
    lo.prototype.measure = function() {
        ...
        if ("function" == typeof ocbptions) throw new Error("render() no longer takes a callback");
        this.measure();
        for (var e, t = 0, s = 0, o = [], a = 0; a < this.scripts.length; a++) e = this.scripts[a], s && (s += 10), e.y = s, o.push(es.move(0, s, e.draw())), s += e.height, t = A(t, e.width + 4);
        this.width = t, this.height = s;
        var n = es.newSVG(t, s);
        return n.appendChild(this.defs = es.withChildren(es.el("defs"), eo())), n.appendChild(es.group(o)), this.el = n, n
    }, lo.prototype.exportSVGString = function() {
        if (null == this.el) throw new Error("call draw() first");
        var e = $s();
        this.defs.appendChild(e);
        var t = new es.XMLSerializer().serializeToString(this.el);
        return this.defs.removeChild(e), t
    }, lo.prototype.exportSVG = function() {
        var e = this.exportSVGString();
        return "data:image/svg+xml;utf8," + e.replace(/[#]/g, encodeURIComponent)
    }, lo.prototype.toCanvas = function(e, t) {
        t = t || 1;
        var s = es.makeCanvas();
        s.width = this.width * t, s.height = this.height * t;
        var o = s.getContext("2d"),
    ...
    }, lo.prototype.exportPNG = function(e, t) {
        this.toCanvas(function(t) {
            if (URL && URL.createObjectURL && Blob && t.toBlob) t.toBlob(function(t) {
                e(URL.createObjectURL(t))
            }, "image/png");
    ...
    var po = function(e) {
        ...
        go = {
            init: function(e) {
                es.init(e), uo.LabelView.measuring = function() {
                    var e = es.makeCanvas();
                    return e.getContext("2d")
                }()
            },
            newView: uo.newView,
            makeStyle: Fs.makeStyle
        },
        fo = function(e) {
            function s(e, t) {
                return c.parse(e, t)
            ...
            function n(e, t, s, o) {
                if (o.inline) {
                    ...
                    s.scripts[0] && !s.scripts[0].isEmpty && (a += " scratchblocks-inline-" + s.scripts[0].blocks[0].shape), i.className = a, i.style.display = "inline-block", i.style.verticalAlign = "middle"
                } else {
        ...
        mo = e(function(e) {
            var t = window.scratchblocks = e.exports = fo(window);
            t.appendStyles()
        });
    return mo
}();